...
This app has a React front-end (in the client directory) and a Node Express back-end (in the api directory). I created the client using create-react-app. I used the code provided to me for the API.
...
## Instructions for Front-end Choose Your Own Adventure Take-Home
